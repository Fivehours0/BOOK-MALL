...
<div id="page_nav">
    <c:if test="${requestScope.page.pageNo > 1}">
        <a href="http://localhost:8080/bookServlet?action=page&pageNo=1">首页</a>
        <a href="http://localhost:8080/bookServlet?action=page&pageNo=${requestScope.page.pageNo-1}">上一页</a>
    </c:if>
